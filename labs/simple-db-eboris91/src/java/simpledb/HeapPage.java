    ...
    */
    ...
    public void insertTuple(Tuple t) throws DbException {
        if (getNumEmptySlots() == 0){
            throw new DbException("Cannot insert, the page is full");
        }
        if (!td.equals(t.getTupleDesc())) {
            throw new DbException("Cannot insert, tupledesc mismatch");
        }
        int i = 0;
        while (isSlotUsed(i)) {
            i++;
    ...
    public Iterator<Tuple> iterator() {
        class TupleIterator implements Iterator<Tuple> {
             ...
             */
            private int emptySlots = getNumEmptySlots();

            /**
             * The number of used slots.
             */
            private int usedSlots = getNumTuples() - emptySlots;
