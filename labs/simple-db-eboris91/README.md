...
### Due: Thursday, June 10th, 2021 (hard deadline, no late days allowed)

### Project Guidelines: This lab includes a final project report summarizing your work on SimpleDB. See the final project instructions [here](https://courses.cs.washington.edu/courses/cse444/21sp/content/Project.html)  for details.
...
The optimizer will be invoked from `simpledb/Parser.java`. You may wish to review the [lab 2 parser exercise](https://gitlab.cs.washington.edu/cse444-21sp/simple-db/blob/lab2/README.md) before starting this lab. Briefly, if you have a catalog file `catalog.txt` describing your tables, you can run the parser by typing:
...
You may submit your code multiple times; we will use the latest version you submit that arrives before the deadline. Place the project report called `lab5-writeup.pdf` in the top level of your repository. This should be your final project report, with lab 5 questions contained within.
...
To git@gitlab.com:cse444-21sp/simple-db-pirateninja.git
 - [deleted]         lab5
...
To git@gitlab.com:cse444-21sp/hsimple-db-pirateninja.git
 * [new tag]         lab5 -> lab5
```
...
```sh
$ git clone git@gitlab.com:cse444-21sp/simple-db-yourname
